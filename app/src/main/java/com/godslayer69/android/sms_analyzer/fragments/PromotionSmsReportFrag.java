...
public class PromotionSmsReportFrag extends Fragment implements View.OnClickListener {
     ...
     * number.
     */
    public static PromotionSmsReportFrag newInstance(int sectionNumber) {
        PromotionSmsReportFrag fragment = new PromotionSmsReportFrag();
    ...
    private void init(Context c, View v){
        ...
        smsDataParser.getSmsAnalysisReport(SmsSqliteHelper.TABLE_PROMOTION, senderNameText,
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.expand_cardview_btn){
            ...
            smsIntent.putExtra("intent_extra_data_key", "OLACBS");
