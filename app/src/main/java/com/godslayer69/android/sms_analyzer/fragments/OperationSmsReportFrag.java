...
public class OperationSmsReportFrag extends Fragment implements View.OnClickListener {
     ...
     * number.
     */
    public static OperationSmsReportFrag newInstance(int sectionNumber) {
        OperationSmsReportFrag fragment = new OperationSmsReportFrag();
    ...
    private void init(Context c, View v){
        ...
        smsDataParser.getSmsAnalysisReport(SmsSqliteHelper.TABLE_OPERATION, senderNameText,
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.expand_cardview_btn){
            ...
            smsIntent.putExtra("intent_extra_data_key", "OLACAB");
